...
The program was made with ease of use in mind. With it you can view TESTS data, SENSORS data, FREEZE FRAME data, clear the trouble codes and live graphs. Currently it only displays live data - no recording and replay is possible.
