...
**This is the remake of the free and open source PC program for car diagnostics, aka. reading and displaying your cars OBD2 data(tests, sensors, DTC faults/reset, graphs of live sensor data). OBD2 is a protocol for displaying engine data only though. Most if not all cars in Europe and USA support the OBD2 if they have been made in the last 20+ years. You will need an adapter called ELM327 to use it, and a laptop. The program was made on top of the pyOBD program, which was made by Donour Sizemore. It is made in the Python programming language, hence the name pyOBD. The original program has not been touched for 15 years, so I decided then, that I will make it my personal project to first make it work on Python 3 and latest libraries, which I successfully did. After that I also expanded its functionality and made it use exclusively the rich Python OBD library, which was made by Brendan Whitfield. So now I have utilized two projects into one. I also added live graphs and many other improvements and made it more "bulletproof". The program is ofcourse still free and open source. It works on Windows, Linux and MacOS. Special thanks goes to Donour Sizemore and Brendan Whitfield. And last, but not least, my name is Jure Poljsak, and this remake was made by me.**
